...
.. note::
   PyAMARES requires Python 3.8 or newer. We recommend using Python 3.12 or newer. If you are using an older version of Python, you will need to upgrade to use pyAMARES.
